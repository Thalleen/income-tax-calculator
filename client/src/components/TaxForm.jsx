...
//   const handleDeductionsChange = debounce((value) => {
//     setDeductions(Math.max(0, Number(value)));
//   }, 300);

//   const handleSubmit = async (e) => {
//     e.preventDefault();
//     console.log("Income:", income, "Deductions:", deductions, "Regime:", taxRegime); // Debugging
//     setIsLoading(true);
...
//           <div>
//             <div className="flex items-center gap-2 mb-2">
//               <label className={`${isDarkMode ? "text-gray-200" : "text-gray-700"} font-medium`}>Deductions</label>
//               <HelpCircle
//                 className="w-4 h-4 text-gray-400 cursor-help"
//                 data-tooltip-id="deductions-tooltip"
//               />
//               <Tooltip id="deductions-tooltip" place="right" content="Include all eligible deductions under sections 80C, 80D, etc." />
//             </div>
//             <div className="relative">
//               <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">₹</span>
//               <input
...
//               <p className={isDarkMode ? "text-gray-200" : "text-gray-700"}><strong>Deductions:</strong> ₹{taxResult.deductions?.toLocaleString()}</p>
...
//       {/* Testimonials */}
//       <div className={`mt-12 ${isDarkMode ? "bg-gray-800" : "bg-gray-50"} py-12`}>
//         <div className="max-w-4xl mx-auto text-center">
//           {/* <h2 className={`text-2xl font-bold mb-6 ${isDarkMode ? "text-gray-200" : "text-gray-800"}`}>What Our Users Say</h2> */}
...
//       {/* Footer */}
//       <footer className={`${isDarkMode ? "bg-gray-800" : "bg-gray-900"} text-white py-8 mt-12`}>
//         <div className="max-w-4xl mx-auto text-center">
//           {/* Footer Content */}
//         </div>
//       </footer>
...
const TaxForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const deductions = section80C + section80D + hra; // Compute total deductions
  
    try {
      const response = await axios.post("http://localhost:5001/api/tax/calculate", {
        income,
        deductions, // Send aggregated deductions
        taxRegime,
      });
